...
// This assumes that Bitfinex trading has been configured to use limit orders in exchanges.js,
// so fees are the "maker fee" of 0.1%.  It does not take into account volume discounts.
...
// TODO: Gekko says "Currently only partially filled orders should 
// be treated as not filled."  However a partially filled Bitfinex
// order may never be filled if the price goes beyond the limit price.
...
Trader.prototype.getTrades = function(since, callback, descending) {
  ...
  // Bitfinex npm module does not support start date, but Bitfinex API does. 
